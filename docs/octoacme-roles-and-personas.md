...
### Role Summary
QA/Testing validates that features meet acceptance criteria and quality standards, focusing on functional correctness and user experience.

### Responsibilities
- Create and run test plans
- Validate acceptance criteria and report issues
- Coordinate regression and smoke testing
...
### Role Summary
Stakeholders provide inputs and approvals and help ensure that project delivers business value.
...
### Role Summary
Senior engineer responsible for technical architecture, design decisions, and technical quality across the project.
...
- Facilitate technical trade-off discussions and document rationale
...
- Partners with DevOps/Platform on operational readiness
...
### Role Summary
Responsible for user research, interaction design, and ensuring design quality and usability.

### Responsibilities
- Lead user research and prototype testing for features
- Produce wireframes, interaction specs, and visual assets
- Validate designs against acceptance criteria and provide accessibility guidance
...
### Role Summary
Coordinates release pipelines, deployment schedules, and rollbacks for production changes.
...
### Role Summary
Ensures security requirements and reviews are part of the project lifecycle.
...
### Role Summary
Owns data definitions, tracking, and analysis that measure success metrics.
...
### Role Summary
Represents customer-facing insights and coordinates support readiness.
...
### Role Summary
Builds and maintains infrastructure, CI/CD, and platform services.
...
### Role Summary
Manages organizational change impact, stakeholder readiness, and rollout coordination.
